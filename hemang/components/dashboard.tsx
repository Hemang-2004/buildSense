            ...
            <div className="mb-8">
              ...
              >
                {projects.map((project) => (
                  <div
                    key={project.id}
                    className="flex items-center space-x-4 mb-4 p-4 rounded-lg hover:bg-white transition-colors"
                  >
                    <RadioGroupItem value={project.id} id={project.id} />
                    <Label htmlFor={project.id} className="flex-1 cursor-pointer">
                      <h2 className="text-2xl font-bold text-[#005792]">{project.name}</h2>
                      <p className="text-gray-600">
                        {project.phase} | Started: {project.startDate}
                      </p>
                    </Label>
                  </div>
                ))}
