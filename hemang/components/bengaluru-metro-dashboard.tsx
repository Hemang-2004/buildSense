...
export default function BengaluruMetroDashboard() {
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
      ...
      <main className="container mx-auto px-4 py-8">
        <motion.div variants={container} initial="hidden" animate="show" className="space-y-6">
          <motion.div variants={item}>
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-[#005792] mb-2">Bengaluru Metro Phase 2</h1>
              <p className="text-gray-600">Underground Section | Started: Mar 2024</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <Card className="p-6">
                ...
                <p className="text-2xl font-bold text-[#005792]">35%</p>
              </Card>
              ...
              <Card className="p-6">
                ...
                <Progress value={21} className="mb-2" />
                <p className="text-2xl font-bold text-[#005792]">$3.2M / $15M</p>
              </Card>
              ...
              <Card className="p-6">
                ...
                <p className="text-sm text-gray-600">Ground stability concerns</p>
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="text-2xl font-bold text-[#005792]">486</div>
